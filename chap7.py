...
# 画像データを読み込み
images = [ImageTk.PhotoImage(Image.open("img6/chap6-mapfield.png")),
          ImageTk.PhotoImage(Image.open("img6/chap6-mapwall.png")),
          ImageTk.PhotoImage(Image.open("img6/chap6-mapgoal.png")),
          ImageTk.PhotoImage(Image.open("img6/chap6-mapkey.png")),
          ImageTk.PhotoImage(Image.open("img6/chap6-mapman.png")),
          ImageTk.PhotoImage(Image.open("img6/chap7-mapmonster.png"))]
